...
{
    S_1.Kp = (float32_t)(pid_1[0][0])*100 + (float32_t)(pid_1[0][1])*100 + (float32_t)(pid_1[0][2]) + (float32_t)(pid_1[0][3])*0.1 + (float32_t)(pid_1[0][4])*0.01;
    S_1.Ki = (float32_t)(pid_1[1][0])*10 + (float32_t)(pid_1[1][1]) + (float32_t)(pid_1[1][2])*0.1 + (float32_t)(pid_1[1][3])*0.01 + (float32_t)(pid_1[1][4])*0.001;
    S_1.Kd = (float32_t)(pid_1[2][0]) + (float32_t)(pid_1[2][1]*0.1) + (float32_t)(pid_1[2][2])*0.01 + (float32_t)(pid_1[2][3])*0.001 + (float32_t)(pid_1[2][4])*0.0001;

    arm_pid_init_f32(&S_1, 0);

    S_2.Kp = (float32_t)(pid_2[0][0])*100 + (float32_t)(pid_2[0][1])*10 + (float32_t)(pid_2[0][2]) + (float32_t)(pid_2[0][3])*0.1+(float32_t)(pid_2[0][4])*0.01;
    S_2.Ki = (float32_t)(pid_2[1][0])*10 + (float32_t)(pid_2[1][1]) + (float32_t)(pid_2[1][2])*0.1+(float32_t)(pid_2[1][3])*0.01+(float32_t)(pid_2[1][4])*0.001;
    S_2.Kd = (float32_t)(pid_2[2][0]) + (float32_t)(pid_2[2][1])*0.1 + (float32_t)(pid_2[2][2])*0.01 + (float32_t)(pid_2[2][3])*0.001 + (float32_t)(pid_2[2][4])*0.0001;
